package com.github.SnowFlakes.Image;

import com.github.SnowFlakes.File.FileTool;
...
//                    im.setRGB(j, i, new Color(255, 255 - (int) (Math.sqrt(Matrix[i][j] / Max) * 255), 255 - (int) (Math.sqrt(Matrix[i][j] / Max) * 255)).getRGB());
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        if (args.length == 0) {
            new HelpFormatter().printHelp("java -cp DLO-HiC-AnalysisTools.jar com.github.SnowFlakes.Image.HeatMap [option]", Argument);
            System.exit(1);
        }
