...
public class PetCluster {
    ...
    private PetCluster(String[] args) throws ParseException {
        ...
        Argument.addOption(Option.builder("t").longOpt("ThreadNum").argName("int").hasArg().desc("run threads").build());
...
//                    if (Length == 0) {
//                        com.github.SnowFlakes.System.err.println("Error! extend length is 0");
//                        com.github.SnowFlakes.System.exit(1);
//                    }
...
//                    break;
//                default:
//                    com.github.SnowFlakes.System.err.println(PetCluster.class.getName() + ":\tError format !");
//                    com.github.SnowFlakes.System.exit(1);
//            }
